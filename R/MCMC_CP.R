#' MCMC sampler for change point model.
#'
#' \code{CP} is a Markov chain Monte Carlo (MCMC) sampler for a change point
#'  model with location varying slopes, intercepts, and unique variances at each spatialtemporal
...
#' @export
CP <- function(Y, DM, W, Time, Starting = NULL, Hypers = NULL, Tuning = NULL, MCMC = NULL,
  ...
  RegObj <- CP_Rcpp(DatObj, HyPara, MetrObj, Para, DatAug, McmcObj, RawSamples, Interactive)
