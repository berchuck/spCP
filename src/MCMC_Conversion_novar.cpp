...
datobj_novar ConvertDatObj_novar(Rcpp::List DatObj_List) {
  ...
  arma::mat Eye4 = DatObj_List["Eye4"];
  arma::mat Eye4M = DatObj_List["Eye4M"];
...
metrobj_novar ConvertMetrObj_novar(Rcpp::List MetrObj_List) {
  ...
  //Set objects from List
  arma::vec MetropLambdaVec = MetrObj_List["MetropLambdaVec"];
  arma::vec AcceptanceLambdaVec = MetrObj_List["AcceptanceLambdaVec"];
